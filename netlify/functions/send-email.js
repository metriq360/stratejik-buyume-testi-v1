...
export const handler = async (event) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: userInfo.email,
      subject: `IQ360™ Analiz Raporun Hazır (Skor: ${results.total}/100)`,
      html: `
        <div style="font-family:sans-serif; max-width:600px; margin:auto; border:1px solid #eee; padding:20px; border-radius:20px;">
          ...
          <p>Selam ${userInfo.name}, sonuçların hazır:</p>
    ...
    return { statusCode: 500, headers, body: JSON.stringify({ error: "Hata", details: error.message }) };
  }
};
